...
- **Deze codebase wordt het fundament van de nieuwe hazenco.nl**, op het hoofddomein (custom Next.js), met de toolkit en de marktplaats als onderdeel. De huidige WordPress-hazenco.nl wordt uitgefaseerd.
...
2. **Fase 0 — positionering & IA:** help me de sitemap van de nieuwe hazenco.nl scherpstellen: home, dienstenpagina's (webdesign, procesautomatisering, AI-workflows), cases/portfolio, over-ons, contact (Resend-formulier), blog, plus waar de gratis toolkit en de marktplaats landen.
3. Advies over scope: eerst alleen **merk + toolkit** live en de marktplaats gefaseerd, of alles ineens?
