...
- **Container poort:** 5052 (intern), proxied via Nginx
...
- Poort 5052 al in gebruik → `sudo lsof -i :5052` of `sudo netstat -tlnp | grep 5052`
...
- [ ] Firewall: `ufw allow 22,80,443/tcp` en blok 5052 van extern (alleen via Nginx)
